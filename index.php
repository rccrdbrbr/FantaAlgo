            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1>PierAlgo è qui <strong>per TE!</strong></h1>
                        <p>Il nostro servizio aiuterà a guardare con un occhio critico il tuo campionato.</p>
                        <a href="#about" class="main-button-slider">Scopri di più</a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                    <div class="left-heading">
                        <h5>Viviamo in una società in cui non sempre i migliori vengono ricompensati</h5>
                    </div>
                    <div class="left-text">
                        <p>Grazie ai nostri approfonditi e continuati studi stiamo cercando di creare un sistema in cui la meritocrazia ne facesse da padrona.
                        Il PierAlgo serve proprio per dare una visione critica alla classifica, cercando di mettere da parte colpi di fortuna o di sfortuna.
                      </p>
                        <a href="#about2" class="main-button">Tabella Giornate</a>
                    </div>
                </div>
            </div>
            <div class="row">
